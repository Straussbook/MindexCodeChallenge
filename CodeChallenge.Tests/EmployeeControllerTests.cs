...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        public void GetStructureById_Returns_Ok()
        {
            ...
            //Assert
            Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
            Assert.AreEqual(numberOfReports, structure.numberOfReports);
        }
        ...
        public void CreateCompensation_Returns_Conflict()
        {
            ...
            //Hit the endpoint twice to ensure that the comp is already in the db
            var postResponse = postRequestTask.Result;
            postResponse = postRequestTask.Result;
